...
class AmazonS3ResourceManager extends Component implements ResourceManagerInterface
{
     ...
     * @return type
     */
    public function deleteMatching($prefix)
    {
        return $this->getClient()->deleteMatchingObjects($this->bucket, $prefix);
    }

    /**
     * Return the full path a file names only (no directories) within s3 "directory" by treating s3 keys as path names.
    ...
    public function listFiles($directory)
    {
        ...
        foreach ($iterator as $object) {
            // don't return directories - just files
